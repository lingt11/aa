...
namespace TMPro.Examples
{
	...
	{
		// Token: 0x06001827 RID: 6183 RVA: 0x00096978 File Offset: 0x00094B78
		private void Awake()
		{
			this.m_TextComponent = base.gameObject.GetComponent<TMP_Text>();
		}

		// Token: 0x06001828 RID: 6184 RVA: 0x0009698B File Offset: 0x00094B8B
		private void Start()
		{
			base.StartCoroutine(this.WarpText());
		}

		// Token: 0x06001829 RID: 6185 RVA: 0x0009699A File Offset: 0x00094B9A
		...
		// Token: 0x0600182A RID: 6186 RVA: 0x000969AD File Offset: 0x00094BAD
